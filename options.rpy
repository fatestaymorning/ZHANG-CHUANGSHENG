...
define trans_mainmeau = ImageDissolve("trans_mainmeau.png", 1.0, reverse=True)
define trans_navimeau = ImageDissolve("trans_kick.png", 1.5)
define trans2 = ImageDissolve("trans2.png", 1.0)
define trans_mainmeau = ImageDissolve("trans_mainmeau.png", 1.0, reverse=True)
define trans_eye_shut = ImageDissolve("images/trans/eye.png", 2.0, reverse=True)
define trans_eye_open = ImageDissolve("images/trans/eye_open.png", 2.0, reverse=True)

## 进入或退出游戏菜单。images/chara/

define config.enter_transition = trans_mainmeau
define config.exit_transition = trans_mainmeau
...
define config.save_directory = "gg-1611556747"
